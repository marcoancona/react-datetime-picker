...
var DateTimePicker = function (_PureComponent) {
  ...
  function DateTimePicker() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DateTimePicker.__proto__ || Object.getPrototypeOf(DateTimePicker)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.inputRef = _react2.default.createRef(), _this.onClick = function (event) {
    ...
    }, _this.focusOn = function (elementName) {
      if (_this.inputRef.current) _this.inputRef.current.focusOn(elementName);
  ...
  _createClass(DateTimePicker, [{
    ...
    value: function renderInputs() {
      var _props = this.props,
          ...
          name = _props.name,
          onPrevNavigation = _props.onPrevNavigation,
          onNextNavigation = _props.onNextNavigation,
          required = _props.required,
          showLeadingZeros = _props.showLeadingZeros,
          stepMinute = _props.stepMinute,
          value = _props.value;
